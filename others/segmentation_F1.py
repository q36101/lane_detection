...
#################################################################
#  标签图像文件夹
LabelPath = 'C:/Users/HLY/lane_detection/data/BOSCH/color_images/color_images/valid/images-2014-12-22-12-35-10_test_binary_502/'

#  预测图像文件夹
path = 'C:/Users/HLY/Desktop/pre(5-22)/pool_add_llamas/test/'
PredictPath = path
