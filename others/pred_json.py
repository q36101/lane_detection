...
def maxArea(probs, h, w):
    ...
    print('binary',binary.shape,type(binary),binary)
    print('Probs',probs)
...
# w =  1280 # 640
# if test == 'val':
#     exp = 'C:/Users/HLY/Desktop/pre(5-20)/pool_128_64_32_psan_tut'
#     List = open('/val.txt', 'r')
#     pred = open('C:/Users/HLY/Desktop/pre(5-20)/pool_128_64_32_psan_tut/pool_128_64_32_psan_tut.json', 'w')
# else:
#     exp = 'C:/Users/HLY/Desktop/pre(5-20)/'
#     pred = open('D:/Users/mediacore/lane_detection/test.json', 'w')
# thr = 0.2
# def default(o):
#     if isinstance(o, np.int64): return int(o)  
#     raise TypeError
# for n in range(1,2783):
#     print(n)
#     line='D:/Users/mediacore/lane_detection/test/'+str(n)+'.jpg'
#     img_path = line.split()[0]
#     time = int(float(n)*1000)
#     lanes = []
#     probs = cv2.imread(line, 0)
...
#     lanes = cutMax(lanes)
#     print(img_path)
#     data = {'raw_file' : img_path, 'lanes' : lanes, 'run_time' : time}
...
if test == 'val':
    ...
    pred = open('pool_128_64_32_psan_tut.json', 'w')
else:
