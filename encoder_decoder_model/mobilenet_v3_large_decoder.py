...
class mobilenet_v3_large_Decoder(cnn_basenet.CNNBaseModel):
    """
    實現一個全卷積解碼類
    """
    def __init__(self):
...
if __name__ == '__main__':
    ...
    mobilenet_v3_large_encoder = mobilenet_v3_large_encoder.mobilenet_v3_large_Encoder(phase=tf.constant('train', tf.string))
