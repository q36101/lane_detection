...
        :return:
        ...
        with tf.compat.v1.variable_scope(name):
            ...
            print('fpn_list[0]',fpn_list[0])
            print('fpn_list[1]',fpn_list[1])
            print('fpn_list[2]',fpn_list[2])
            print('fpn_list[3]',fpn_list[3])
            ...
            deconv_1 = tf.compat.v1.layers.batch_normalization(output_d1)
            
            output_r1 = tf.image.resize(tf.expand_dims(tf.reduce_mean(tf.abs(result_1)**2, axis=3), axis=3), (128, 256))
            result_1 = tf.compat.v1.layers.batch_normalization(output_r1)
            ...
            ret['deconv_1'] = deconv_1
            ret['result_1'] = result_1
...
if __name__ == '__main__':
    ...
    mobilenet_v3_large_encoder = mobilenet_v3_large_encoder_pool.mobilenet_v3_large_Encoder(phase=tf.constant('train', tf.string))
