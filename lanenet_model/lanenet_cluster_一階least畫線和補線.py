# -*- coding: utf-8 -*-
"""
Created on Tue Dec 29 16:17:53 2020

@author: mediacore
"""

"""
實現LaneNet中實例分割的聚類部分  (lanenet_cluster_一階least畫線和補線)
"""
import numpy as np
import glog as log
...
#            print(m, 'mmmmmmmmmmmmmmmmm')
            ...
            model.fit(coord_x[:,np.newaxis],coord_y) #一階least
            m = model.coef_
            
#            poly_model.fit(coord_x[:, np.newaxis], coord_y) #二階least
#            coord_y = poly_model.predict(coord_x[:, np.newaxis]) #二階least
