            ...
            for epoch in range(epoch_nums):
                ...
                for index, binary_seg_image in enumerate(binary_seg_images):
                    ...
                    if save_dir is not None:
                        mask_image=test2*test*255
                        # print('image_vis_list[index]',type(image_vis_list[index]))
                        # print('mask_image',type(mask_image))
                        # mask_image = np.array(mask_image,dtype='uint8')*100/255
                        ...
                        # cv2.imwrite(image_save_path, test2*test*255)
